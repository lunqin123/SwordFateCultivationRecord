...
public partial class MainUI : Control
{
	...
	static PanelContainer MakeCard(int minWidth) { var card = new PanelContainer { CustomMinimumSize = new Vector2I(minWidth, 0), ClipContents = true }; var s = UITheme.CardStyle(); s.ContentMarginLeft = 8; s.ContentMarginRight = 8; s.ContentMarginTop = 8; s.ContentMarginBottom = 8; card.AddThemeStyleboxOverride("panel", s); var content = new VBoxContainer(); card.AddChild(content); card.MouseEntered += () => UIAnimator.CardHoverEnter(card); card.MouseExited += () => UIAnimator.CardHoverExit(card); return card; }
