...
public partial class MainUI : Control
{
	...
	static Label TB(string t, Color c, int fs) { var lb = new Label { Text = t, AutowrapMode = TextServer.AutowrapMode.WordSmart, HorizontalAlignment = HorizontalAlignment.Center }; lb.AddThemeFontSizeOverride("font_size", fs); lb.AddThemeColorOverride("font_color", c); return lb; }
	static Label EL() { var lb = new Label { HorizontalAlignment = HorizontalAlignment.Center, AutowrapMode = TextServer.AutowrapMode.WordSmart }; lb.AddThemeFontSizeOverride("font_size", 11); lb.AddThemeColorOverride("font_color", UITheme.TextGreen); return lb; }
	...
	static void StatCard(GridContainer grid, string label, string value, Color valColor) { var card = new PanelContainer { CustomMinimumSize = new Vector2I(140, 60) }; var style = UITheme.CardStyle(); style.ContentMarginLeft = 10; style.ContentMarginRight = 10; style.ContentMarginTop = 8; style.ContentMarginBottom = 8; card.AddThemeStyleboxOverride("panel", style); var cv = new VBoxContainer(); card.AddChild(cv); var lb = new Label { Text = label, HorizontalAlignment = HorizontalAlignment.Center }; lb.AddThemeFontSizeOverride("font_size", 11); lb.AddThemeColorOverride("font_color", UITheme.TextDim); cv.AddChild(lb); var vl = new Label { Text = value, HorizontalAlignment = HorizontalAlignment.Center }; vl.AddThemeFontSizeOverride("font_size", 22); vl.AddThemeColorOverride("font_color", valColor); cv.AddChild(vl); grid.AddChild(card); }
	...
	static Button Btn(string text) { var b = new Button { Text = text, Alignment = HorizontalAlignment.Center, CustomMinimumSize = new Vector2I(100, 36) }; b.AddThemeFontSizeOverride("font_size", 13); b.AddThemeColorOverride("font_color", UITheme.TextPrimary); b.AddThemeColorOverride("font_hover_color", UITheme.Gold); b.AddThemeStyleboxOverride("normal", UITheme.BtnStyleNormal()); b.AddThemeStyleboxOverride("hover", UITheme.BtnStyleHover()); b.AddThemeStyleboxOverride("pressed", UITheme.BtnStylePressed()); return b; }
	static Button SmallBtn(string text) { var b = new Button { Text = text, Alignment = HorizontalAlignment.Center, CustomMinimumSize = new Vector2I(60, 24) }; b.AddThemeFontSizeOverride("font_size", 11); b.AddThemeColorOverride("font_color", UITheme.TextPrimary); b.AddThemeColorOverride("font_hover_color", UITheme.Gold); b.AddThemeStyleboxOverride("normal", UITheme.BtnStyleNormal()); b.AddThemeStyleboxOverride("hover", UITheme.BtnStyleHover()); b.AddThemeStyleboxOverride("pressed", UITheme.BtnStylePressed()); return b; }
}
